            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-96">
                ...
                <form wire:submit.prevent="guardar">
                    ...
                    <div class="mt-4 flex justify-end">
                        <button type="button" wire:click="cerrarModal" class="px-4 py-2 bg-gray-300 rounded mr-2 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600">Cancelar</button>
